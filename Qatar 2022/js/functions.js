...
function armarURL() {
  ...
  //var url = "https://pollamundialista.com/app/simulador";
  var url = "https://pollamundialista.com/app/";
  //console.log(url);
  url = url + "?p=";
  ...
  window.open(
    "https://www.facebook.com/sharer/sharer.php?s=100&p%5Btitle%5D=%C2%A1&p%5Bsummary%5D=el&p%5Burl%5D=" +
      url +
      "&p%5Bimages%5D%5B0%5D=https%3A%2F%2Fpollamundialista.com%2Fapp%2Fsimulador%2Fimg%2Ftonito.jpg",
    "nuevo",
...
function completarPais(id, pais) {
  switch (pais) {
    case "A1":
      completar(id, pais, "Qatar", "qatar");
      break;
    case "A2":
      completar(id, pais, "Ecuador", "ecuador");
      break;
    case "A3":
      completar(id, pais, "Senegal", "senegal");
      break;
    case "A4":
    ...
    case "B3":
      ...
      break;
    case "B4":
      completar(id, pais, "Gales", "gales");
      break;
    case "C1":
      completar(id, pais, "Argentina", "argentina");
      break;
    case "C2":
      completar(id, pais, "Arabia Saudita", "arabiasaudita");
      break;
    case "C3":
      completar(id, pais, "México", "mexico");
      break;
    case "C4":
      completar(id, pais, "Polonia", "polonia");
      break;
    case "D1":
      completar(id, pais, "Francia", "francia");
      break;
    case "D2":
      completar(id, pais, "Dinamarca", "dinamarca");
      break;
    case "D3":
      completar(id, pais, "Turquía", "turquia");
      break;
    case "D4":
      completar(id, pais, "Australia", "australia");
      break;
    case "E1":
      completar(id, pais, "España", "españa");
      break;
    case "E2":
    ...
    case "F1":
      ...
      break;
    case "F2":
      completar(id, pais, "Canada", "canada");
      break;
    case "F3":
      completar(id, pais, "Marruecos", "marruecos");
      break;
    case "F4":
    ...
    case "G1":
      ...
      break;
    case "G2":
      completar(id, pais, "Serbia", "serbia");
      break;
    case "G3":
